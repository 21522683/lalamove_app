...
export const registerUserAction = createAsyncThunk(
    ...
    async (payload, { rejectWithValue, getState, dispatch }) => {
        ...
        //http call
        try {
            const { data } = await axios.post(`${baseUrl}/auth/register-user`, payload.bd, config);
...
export const sendRequestResetAction = createAsyncThunk(
    ...
    async (payload, { rejectWithValue, getState, dispatch }) => {
        try {
            ...
            const { data } = await axios.get(`${baseUrl}/auth/check-phone?phoneNumber=${payload.pn}`, config);
...
export const checkOtpAction = createAsyncThunk(
    ...
    async (payload, { rejectWithValue, getState, dispatch }) => {
        try {
            ...
            const { data } = await axios.get(`${baseUrl}/auth/${payload.pn}/check-otp?otp=${payload.otp}`, config);
...
export const resetPassAction = createAsyncThunk(
    ...
    async (payload, { rejectWithValue, getState, dispatch }) => {
        try {
            ...
            const { data } = await axios.post(`${baseUrl}/auth/reset-password`, payload.body, config);
