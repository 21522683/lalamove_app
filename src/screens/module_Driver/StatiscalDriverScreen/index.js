          ...
          <View style={styles.info_container}>
            <View style={styles.item_info}>
              ...
              <Text style={styles.content}>
                {formatMoney(dataReport.totalRevenue)}
              </Text>
            </View>
            ...
            <View style={styles.item_info}>
              ...
              <Text style={styles.content}>
                {formatMoney(dataReport.totalOfSystem)}
              </Text>
            </View>
            ...
            <View style={styles.item_info}>
              ...
              <Text style={styles.content}>
                {formatMoney(dataReport.totalOfDriver)}
              </Text>
            </View>
          </View>
        ...
        <View style={styles.container_driver}>
          ...
          <ScrollView style={styles.list}>
            {dataReport.orders?.map((item, index) => {
              return <ItemOrderStatiscal key={index} item={item} />;
            })}
          </ScrollView>
        </View>
      </ScrollView>
