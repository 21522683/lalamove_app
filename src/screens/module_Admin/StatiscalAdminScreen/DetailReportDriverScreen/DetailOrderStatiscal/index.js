        ...
        <View style={{flexDirection: 'column', padding: moderateScale(20)}}>
          <View style={{flexDirection: 'column'}}>
            ...
            <View
              ...
              <Text style={styles.content_item}>
                {dataApi.customer?.fullName}
              </Text>
            </View>
            <View
              style={{
            ...
            <View
              ...
              <Text style={styles.content_item}>
                {dataApi.drive?.vehicles[0].vehicleName}
              </Text>
            </View>
          ...
          <View style={{flexDirection: 'column'}}>
            ...
            <View
              ...
              <Text style={styles.content_item}>
                {dataApi.sourceAddress?.detail
                  ? dataApi.sourceAddress?.detail +
                    ', ' +
                    dataApi.sourceAddress?.addressString
                  : dataApi.sourceAddress?.addressString}
              </Text>
            </View>
          </View>
          ...
          <View style={{flexDirection: 'column'}}>
            ...
            <View
              ...
              <Text style={styles.title_item}>Họ tên:</Text>
              <Text style={styles.content_item}>
                {dataApi.sourceAddress?.fullName}
              </Text>
            </View>
            <View
              style={{
              ...
              <Text style={styles.title_item}>Số điện thoại:</Text>
              <Text style={styles.content_item}>
                {dataApi.sourceAddress?.phoneNumber}
              </Text>
            </View>
            <View
              style={{
          ...
          <View style={{flexDirection: 'column'}}>
            ...
            <View
              ...
              <Text style={styles.title_item}>Họ tên:</Text>
              <Text style={styles.content_item}>
                {dataApi.destinationAddress?.fullName}
              </Text>
            </View>
            <View
              style={{
              ...
              <Text style={styles.title_item}>Số điện thoại:</Text>
              <Text style={styles.content_item}>
                {dataApi.destinationAddress?.phoneNumber}
              </Text>
            </View>
            <View
              style={{
              ...
              <Text style={styles.title_item}>Địa chỉ nhận hàng:</Text>
              <Text style={styles.content_item}>
                {dataApi.destinationAddress?.detail
                  ? dataApi.destinationAddress?.detail +
                    ', ' +
                    dataApi.destinationAddress?.addressString
                  : dataApi.destinationAddress?.addressString}
              </Text>
            </View>
          </View>
