...
import {
  addVoucherAction,
  updateVoucherAction,
} from '../../../../../redux/slices/voucherSlices.js';
      ...
      <View
        ...
        <ScrollView style={{marginTop: 0, width: '100%', height: '70%'}}>
          ...
          <Input
            ...
            label="Áp dụng cho"
            placeholder={
              inputs.applyFor === '' ? 'Áp dụng cho' : inputs.applyFor
            }
        ...
        <View style={{width: '100%', flex: 1, justifyContent: 'flex-end'}}>
          <MyButton text={'Lưu'} onPress={validate} />
        </View>
      </View>
      <View
        style={{
          ...
          bottom: 0,
          display: showchosenType ? 'flex' : 'none',
          zIndex: 11,
          height: '100%',
        ...
        <TouchableOpacity
          onPress={() => {
            setShowchosenType(false);
            handleError(null, 'applyFor');
          }}
          style={{margin: 20}}>
          ...
          renderItem={({item}) => (
            <TouchableOpacity
              ...
              <View
                ...
                <View
                  style={{flex: 3, height: '100%', justifyContent: 'center'}}>
                  <Text
                    style={{
                      fontSize: scale(16),
                      fontWeight: '400',
