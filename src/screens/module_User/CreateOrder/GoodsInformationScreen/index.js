import { View, Text, TouchableOpacity, TextInput, Switch, Pressable, Image, ScrollView, SafeAreaView } from 'react-native'
  ...
  return (
    <SafeAreaView style={{flex: 1,  backgroundColor: 'white'}}>
        <Surface style={styles.header}>
            ...
            <Text style={{fontSize: 18, fontWeight: '600'}}>Thông tin hàng hóa</Text>
        ...
        <ScrollView>
          <View style={[styles.body, {gap: 32, backgroundColor:'white'}]}>
              <View style={[{paddingVertical: 16, paddingHorizontal: 24, 
                ...
                paddingBottom: 24,
                gap: 28},styles.shadowCard]}>
                <View style={{gap:12}}>
                  <View style={{flexDirection:'row', alignItems: 'center', gap:8}}>
                  <Icon4 name='package' size={24} color='#F16722'/>
                    <Text style={{color: '#222222', fontSize:15, fontWeight: '500'}}>Đặc điểm hàng hóa</Text>
                  </View>
                  <TextInput
                ...
                <View style={{gap:12}}>
                  ...
                  <Icon7 name='description' size={24} color='#F16722'/>
                    <Text style={{color: '#222222', fontSize:15, fontWeight: '500'}}>Mô tả sơ lược hàng hóa</Text>
                  </View>
                  <TextInput
                  ...
                  multiline={true}
                  numberOfLines={6}
                  style={[styles.textInput, {height: 'unset', textAlignVertical: 'top'}]}></TextInput>
                </View>
  
                <View style={{gap:12}}>
                  <View style={{flexDirection:'row', alignItems: 'center', gap:8}}>
                  <Icon3 name='image' size={24} color='#F16722'/>
                    <Text style={{color: '#222222', fontSize:15, fontWeight: '500'}}>Ảnh chụp hàng hóa</Text>
                  </View>
                  <Pressable onPress={selectImage}>
                    <View style={[
                      {width: 180, height:120, borderWidth: image ? 0 : 1, 
                        borderStyle: 'dashed', borderColor: '#F16722',
                        overflow:'hidden',
                        borderRadius: 4, alignItems: 'center',justifyContent: 'center'},
                        
                    ]}>
                        {
                          image ?  <Image style={{width: '100%', height:'100%', resizeMode:'cover'}}
                          source={{uri: image.uri}}/>
                          :
                          <View style={{flexDirection: 'row',  alignItems: 'center'}}>
                          <Icon3 name='pointer' size={40} color='#F16722'/>
                          <Text style={{color: '#F16722', fontSize:16, fontWeight: '500'}}>Thêm ảnh</Text>
                        </View>
                        }
                ...
                <View style={{gap:12}}>
                  ...
                  <Icon7 name='edit-note' size={24} color='#F16722'/>
                    <Text style={{color: '#222222', fontSize:15, fontWeight: '500'}}>Ghi chú cho tài xế</Text>
                  </View>
                  <TextInput
