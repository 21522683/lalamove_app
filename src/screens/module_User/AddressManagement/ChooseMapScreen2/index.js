...
const ChooseMapScreen2 = ({route}) => {
  const {latitude, longitude} = route.params.ok;
  ...
  const getLocation = async () => {
    const response = await GetInfoFromCoordinates(latitude, longitude);
...
export default ChooseMapScreen2;
